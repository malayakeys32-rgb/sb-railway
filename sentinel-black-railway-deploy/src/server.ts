...
const jwtConfigured = process.env.JWT_SECRET !== undefined && process.env.JWT_SECRET !== FALLBACK_JWT;
...
app.get("/health", (_req, res) => {
  res.json({ status: "ok", timestamp: new Date().toISOString(), jwtConfigured });
});
